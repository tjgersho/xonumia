...
exports.randomPosition = function (radius) {
    return {
        x: exports.randomInRange(radius, 10 - radius),
        y: exports.randomInRange(radius, 10 - radius)
    };
};

exports.bigRandomPosition = function(radius){
	return {
        x: exports.randomInRange(radius, 20 - radius),
        y: exports.randomInRange(radius, 20 - radius)
    };
};
...
exports.findUserId = function(arr, id) {
    var len = arr.length;

    while (len--) {
        if (arr[len].userId === id) {
            return len;
        }
    }
...
exports.findUser = function(arr, id) {
    var len = arr.length;

    while (len--) {
        if (arr[len].user_id === id) {
            return len;
        }
    }
